...
# TRADUCCIÓN DE COMBUSTIBLES PETROBRAS (Mapeo solicitado)
MAPA_COMBUSTIBLE = {
...
# MAPEO DE ENCARGADOS CON SUS BARRLES (Auditoria tiene acceso total)
ENCARGADOS_DATA = {
...
with tab1:
    ...
    if pwd_input == ENCARGADOS_DATA[encargado_sel]["pwd"]:
        ...
        # Auditoria ve todo, los demás solo su barril
        ...
        with st.form("form_final_ekos", clear_on_submit=True):
            ...
            if st.form_submit_button("✅ GUARDAR REGISTRO"):
                if not chofer or not actividad:
                    st.warning("⚠️ Por favor completa los campos.")
                else:
...
# --- TAB 2: AUDITORÍA & STOCK (DESGLOSE POR COMBUSTIBLE) ---
with tab2:
